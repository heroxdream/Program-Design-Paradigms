...
; check-typ? : Symbol Symbol -> Boolean
...
; render-chat-participants : Users -> Image
...
; render-message-area ; Events -> Image
...
; truncated-lst : List -> List
; Returns a truncated list of users
; STRATEGY : Function compostion
...
; truncated-event-image : Events -> Events
; Returns the truncated list of events
; STRATEGY : ???
...
; truncate : Events Natural -> Events
...
; Converst the events to a list of images
; STRATEGY : Data decomposition on e : Events
...
(define (find-pos str width)
  (local ((define (find-pos/a str width a)
...
; Returns 'private or 'broadcast depending on type of the message
; STRATEGY : Data decomposition on w : World
