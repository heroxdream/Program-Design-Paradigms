...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 03-2-draggable-cat) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;; draggable cat.
